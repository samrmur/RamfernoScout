...
import org.ramferno.scoutapplication.ramfernoscout.parsers.MatchDataParser;
...
//Start of MatchDownloader
public class MatchDownloader extends AsyncTask<Void,Void,String> {
    ...
    //Make context, URL Address and ListView equal to the ones provided by the MatchFragment
    public MatchDownloader(Context c, String urlAddress, ListView lv) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        if(s == null) {
            ...
            MatchDataParser parser = new MatchDataParser(c,lv,s);
            parser.execute();
        } //End of if statement
